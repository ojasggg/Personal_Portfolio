...
const Navbar = () => {
  ...
  return (
    <nav className="mx-auto mt-[30px] flex w-[90%] items-center justify-between lg:w-[1200px] xl:w-[1600px]">
      {/* Ojash Gurung Logo */}
      <div>
        {/* TODO: Logo Animation 
      ...
      {/* <div
        className={`absolute top-0 ${
          toggleMenu
            ? "right-0 z-[999] transition-all delay-100 duration-300 ease-in"
            : "-right-full"
