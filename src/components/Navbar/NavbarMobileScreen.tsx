...
const NavbarMobileScreen = ({ navItems }: propsType) => {
  const [toggleMenu, setToggleMenu] = useState<boolean>(false);

  return (
    <>
      <nav className="relative mx-auto flex w-[90%] items-center justify-between py-6 lg:hidden xl:hidden">
        <div>
          {/* TODO: Logo Animation 
      ...
      <div
        className={`absolute top-0 ${
          toggleMenu ? "right-0 z-[999]" : "-right-full"
        } h-screen w-full  bg-black transition-all delay-100 duration-300 ease-in`}
      >
